...
data(){
    return{
        departments:[
            {DepartmentId:1001,DepartmentName:"aaa",},
            {DepartmentId:1002,DepartmentName:"bbb",},
            {DepartmentId:1003,DepartmentName:"ccc",}
        ],
        employees:[
            {EmployeeId:1,EmployeeName:"amy",Department:"aaa",DateOfJoining:"2020-01-01"},
            {EmployeeId:2,EmployeeName:"bill",Department:"bbb",DateOfJoining:"2021-01-01"},
            {EmployeeId:3,EmployeeName:"cindy",Department:"ccc",DateOfJoining:"2022-01-01"}
        ],
        modalTitle:"",
        EmplpoyeeId:0,
        EmployeeName:"",
